...
class Subscriber():
    ...
    def delete_subscribe_topic(self, topic_name, topic_type):
        try:
            ...
            SubscribeTopicInfo = node_pb2.SubscribeTopicInfo(topic_name=topic_name, topic_type=topic_type)
            responses = self.server_stub.DeleteSubscribeTopic(SubscribeTopicInfo)
